				...
				<ul class="nav navbar-nav">
						...
						<ul class="dropdown-menu">
							...
							<li>
								...
								<ul class="menu">
									...
									<li><a href="#">
											<div class="pull-left">
												<img src="<c:url value='/'/>resources/dist/img/user3-128x128.jpg" class="img-circle"
													alt="User Image">
											</div>
											<h4>
									...
									<li><a href="#">
											<div class="pull-left">
												<img src="<c:url value='/'/>resources/dist/img/user4-128x128.jpg" class="img-circle"
													alt="User Image">
											</div>
											<h4>
					...
					<li class="dropdown user user-menu"><a href="#"
						class="dropdown-toggle" data-toggle="dropdown"> <img
							src="<c:url value='/'/>resources/dist/img/user2-160x160.jpg" class="user-image"
						...
						<ul class="dropdown-menu">
							...
							<li class="user-header"><img
								src="<c:url value='/'/>resources/dist/img/user2-160x160.jpg" class="img-circle"
								alt="User Image">
